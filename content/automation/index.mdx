...
Stop doing the same thing twice. Every repetitive task you do manually is time you'll never get back. Let's fix that.
...
<FileTree>
  <FileTree.Folder name="reports" defaultOpen>
    <FileTree.File name="weekly_report_2025-01-15.pdf" />
    <FileTree.File name="weekly_report_2025-01-08.pdf" />
    <FileTree.Folder name="charts" defaultOpen>
      <FileTree.File name="revenue_trend.png" />
      <FileTree.File name="top_products.png" />
      <FileTree.File name="regional_breakdown.png" />
    </FileTree.Folder>
    <FileTree.File name="report.log" />
  </FileTree.Folder>
</FileTree>
