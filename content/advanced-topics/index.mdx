...
|-------|-----------------|
| **Best Practices** | Battle-tested workflows from Anthropic engineers |
| **Custom Skills** | Your own slash commands for repetitive tasks |
| **MCP Integrations** | Connect Claude to databases, APIs, tools |
| **Multi-Claude Patterns** | Parallel verification, complex projects |
