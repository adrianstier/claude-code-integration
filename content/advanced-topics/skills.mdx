...
<InfoTable
  ...
  rows={[
    { command: '/help', does: 'Show all commands', when: 'Discovering features' },
    { command: '/clear', does: 'Reset conversation', when: 'Switching tasks' },
    { command: '/init', does: 'Generate CLAUDE.md', when: 'New projects' },
    { command: '/compact', does: 'Compress context', when: 'Long sessions' },
    { command: '/review', does: 'AI code review', when: 'Before commits' },
    { command: '/memory', does: 'Edit CLAUDE.md', when: 'Updating context' },
    { command: '/permissions', does: 'Manage tools', when: 'Security config' },
  ]}
/>
...
<InfoTable
  ...
  rows={[
    { command: '/deploy', desc: 'Deploy to production' },
    { command: '/fix-issue [n]', desc: 'Fix GitHub issue' },
    { command: '/create-component [name]', desc: 'Create React component' },
  ]}
/>
...
<InfoTable
  ...
  rows={[
    { location: '.claude/commands/skill.md', command: '/skill', scope: 'Project' },
    { location: '.claude/commands/dir/skill.md', command: '/dir/skill', scope: 'Project' },
    { location: '~/.claude/commands/skill.md', command: '/skill', scope: 'Global' },
  ]}
/>
...
<InfoTable
  ...
  rows={[
    { keyword: 'IMPORTANT:', effect: 'High priority' },
    { keyword: 'YOU MUST:', effect: 'Required' },
    { keyword: 'NEVER:', effect: 'Prohibited' },
    { keyword: 'CRITICAL:', effect: 'Absolute' },
  ]}
/>
