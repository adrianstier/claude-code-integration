...
Create reusable prompt templates in `.claude/commands/` as Markdown files. These are called **Skills** - one of Claude Code's most powerful features.
...
<Callout type="tip" title="Deep Dive: Skills">
For comprehensive coverage of Skills including advanced patterns, real-world examples, and best practices, see the dedicated [Claude Skills Guide](/advanced-topics/skills).
</Callout>
